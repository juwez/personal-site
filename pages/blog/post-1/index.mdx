...
It solves the problem of sending huge javascript packages to the users and letting them compile it client side.
...
of course Next.js has a list of other advantages but this is the biggest one in my humble opnionion.
## Why did i make this blog in next.js ?
Next.js also takes a lot of developer problems away.
mainlySEO , while developer always find this one pretty hard , next.js out of the box comes with SEO.
...
This is because next.js has a lot of out of the box support through webpack: asset compilation, hot realoading, code splitting. Anyone with a decent javascript and react knowledge can pick up this framework very easily.
...
However next.js gives you no direct acces to webpack so you need to add these to next.config.js.
...
Once that was all done I only had to create a new folder with a mdx file to make a blog post